...
public class EditCommandParser implements Parser<EditCommand> {
    ...
    public EditCommand parse(String args) throws ParseException {
        ...
        if (argMultimap.getValue(PREFIX_FOLLOW_UP_DATE).isPresent()) {
            editPersonDescriptor.setFollowUpDate(Optional.of(ParserUtil
                    .parseFollowUpDate(argMultimap.getValue(PREFIX_FOLLOW_UP_DATE).get())));
        }

        if (argMultimap.getValue(PREFIX_CIRCLE).isPresent()) {
            editPersonDescriptor.setCircle(Optional.of(ParserUtil
                    .parseCircle(argMultimap.getValue(PREFIX_CIRCLE).get())));
        }
